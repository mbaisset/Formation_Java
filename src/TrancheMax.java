...
class TrancheMax {
    ...
    private static boolean checkFormat(String matrice) {
    ...
    private static ArrayList<Integer> findConsecutiveList(String matrice) {
        ...
        for (int i = 0; i < matriceSplitted.length; i++){
            ...
            } else if (nbMaxUnConsecutifLigne == maxUn){
                consecutiveList.add(i);
            }
        }
    ...
    private static boolean checkLineLength (String matriceLine){
